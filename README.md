...
npm run verifica:completa # tutto quanto: 1892 controlli
```
...
| `redesign.mjs` | markup, CSS, accessibilità | 1041 |
...
| `affidabilita.mjs` | gare di sessione, uscita e rientro nei gruppi, gare fra programmazione e annullamento notifiche, letture altrui, pareggi, gruppi sciolti, gare della sincronizzazione, logout fra schede | 226 |
...
`verifica/redesign.mjs` (1041) controlla l'**interfaccia**: tag JSX e parentesi
